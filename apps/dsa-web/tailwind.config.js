    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-purple-cyan":
          "linear-gradient(135deg, hsla(var(--accent), 0.2) 0%, hsla(var(--primary), 0.1) 100%)",
        "gradient-card-border":
          "linear-gradient(180deg, hsla(var(--accent), 0.4) 0%, hsla(var(--accent), 0.1) 50%, hsla(var(--primary), 0.2) 100%)",
        "gradient-cyan":
