...
export const LLM_PROVIDER_CAPABILITY_LABELS: Record<
...
export const LLM_PROVIDER_TEMPLATES: LLMProviderTemplate[] = [
  ...
  },
  {
    ...
    placeholderModels:
      "Doubao-Seed-2.0-lite,Doubao-Seed-2.0-pro,qwen3.5-flash,MiniMax-M2.7",
    ...
    officialSources: [
      {
        label: "Anspire Open",
        url: "https://open.anspire.cn/?share_code=QFBC0FYC",
      },
      {
  ...
  },
  {
    ...
    officialSources: [
      {
        label: "DashScope Text Generation",
  ...
  },
  {
    ...
    officialSources: [
      {
        label: "MiniMax OpenAI API",
        url: "https://platform.minimax.io/docs/api-reference/text-chat",
      },
      {
        label: "MiniMax Models",
        url: "https://platform.minimax.io/docs/api-reference/models/openai/list-models",
      },
    ],
  },
  {
    ...
    capabilities: ["openai-compatible"],
    configHint:
      "确认在线推理 endpoint / region 与 Coding Plan 专用入口不要混用。",
    officialSources: [
      {
        label: "Volcengine Ark Inference",
        url: "https://www.volcengine.com/docs/82379/2121998",
      },
      {
        label: "Volcengine Ark Models",
        url: "https://www.volcengine.com/docs/82379/1949118",
      },
    ],
  },
  {
    ...
    officialSources: [
      {
        ...
        url: "https://docs.siliconflow.cn/quickstart/models",
      },
    ],
  },
  {
...
export const LLM_PROVIDER_TEMPLATE_BY_ID: Record<string, LLMProviderTemplate> =
  Object.fromEntries(
